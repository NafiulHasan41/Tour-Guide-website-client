            ...
            <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-green-400">
                <form onSubmit={handleLogin} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <button className="btn bg-yellow-300  border-none text-xs md:text-xl ">Login</button>
                    </div>
                ...
                <label className="label text-center  justify-center text-xl">
                        <p className=" mx-3"> New User ?</p>    <Link to="/register"  className="label-text-alt btn bg-green-300 border-none  text-xl text-blue-500"> Register</Link>
                        </label>
            </div>
        </div>
    </div>
