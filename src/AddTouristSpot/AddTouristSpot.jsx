  ...
  return (
    ...
    <form onSubmit={handleAddTouristSpot} className=" bg-gradient-to-b from-cyan-500 to-cyan-200 rounded-2xl p-3 md:p-7 shadow-2xl shadow-cyan-500/70">
        ...
        <label className="label">
            ...
            <input type="text" name="description" placeholder="Short Description" className="textarea textarea-bordered textarea-lg w-full" required />
        </div>
        <div className=" flex flex-col md:flex-row gap-2 md:gap-5">
            ...
            <input type="number" name="average_cost" placeholder="Average_cost" className="input input-bordered w-full" required />
            </div>
            <div className="flex-1">
            <label className="label">
                <span className="label-text text-red-500 text-xl font-bold">
            ...
            <input type="text" name="seasonality" placeholder="Seasonality-like summer , winter" className="input input-bordered w-full" required />
            </div>
            <div className="flex-1">
            <label className="label">
                <span className="label-text text-red-500 text-xl font-bold">
            ...
            <input type="text" name="travel_time" placeholder="Travel_time like-7days" className="input input-bordered w-full" required />
            </div>
            <div className="flex-1">
            <label className="label">
                <span className="label-text text-red-500 text-xl font-bold">
            ...
            <input type="number" name="TotalVisitorPerYear" placeholder="TotalVisitorPerYear" className="input input-bordered w-full" required />
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-5">
            ...
            <input type="text" name="userName" placeholder="UserName" className="input input-bordered w-full" defaultValue={user.displayName} readOnly />
            </div>
            </div>
            <div className="my-3">
